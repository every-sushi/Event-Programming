package rlaskfud0515.kr.hs.emirim.gridcalculator2;
...
public class MainActivity extends AppCompatActivity {
    ...
    View.OnClickListener getButOpHandler = new View.OnClickListener(){
        @Override
        public void onClick(View view){
            ...
            double result=0;
            switch(view.getId()){
                case R.id.but_op1: result=num1+num2; break;
                case R.id.but_op2: result=num1-num2; break;
